...
public class AttachmentUtils {
    ...
    public static final String TYPE_NAME_COMPRESSION = StringUtils.getString(R.string.label_compressed_file);
     ...
     * @return
     */
    public static List<Attachment> netPathToAttachment(List<AttFileInfo> netBodyList) {
        return netPathToAttachment(netBodyList, AttachmentUtils.IS_ALLOW_EDIT_STATUS_EDF);
    }
     ...
     * @return
     */
    public static List<Attachment> netPathToAttachment(List<AttFileInfo> attFileInfoList, int editStatus) {
        ...
        if (attFileInfoList != null && !attFileInfoList.isEmpty()) {
            for (AttFileInfo attFileInfo : attFileInfoList) {
                Attachment attachment = new Attachment(attFileInfo);
                attachment.setIsAllowEditStatus(editStatus);
